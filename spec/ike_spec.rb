    ...
    describe NonESPMarker do
      describe 'bindings' do
        it 'in UDP packets with port 4500' do
          ...
          expect(PacketGen::Header::UDP).to know_header(NonESPMarker).with(sport: 4500)
        end
      end
    end
    ...
    describe IKE do
      describe 'bindings' do
        it 'in UDP packets with port 500' do
          expect(PacketGen::Header::UDP).to know_header(IKE).with(dport: 500)
          expect(PacketGen::Header::UDP).to know_header(IKE).with(sport: 500)
        end
      ...
      describe '#initialize' do
        it 'creates a IKE Plugin with default values' do
          ike = IKE.new
